# Generated by Powerlevel10k configuration wizard on 2026-06-30 at 11:55 CST.
...
() {
  ...
  local -a prompt_extra_segments=(${POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS:#newline})
  prompt_extra_segments=(${prompt_extra_segments:#time})
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    dir
    dir_gap
    vcs
    ${prompt_extra_segments}
    newline
    prompt_char
  )
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=()
  ...
  function prompt_docker() {
    [[ -e /.dockerenv ]] || return
    p10k segment -f blue -t '󰡨in docker'
  }

  function prompt_dir_gap() {
    p10k segment -t '   '
  }
